...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://testingcart-28808.firebaseio.com/"),
    refCart = new Firebase("https://testingcart-28808.firebaseio.com/cart"),
    refUser = new Firebase("https://testingcart-28808.firebaseio.com/users"),
    refCategory = new Firebase("https://testingcart-28808.firebaseio.com/category"),
    refOrder = new Firebase("https://testingcart-28808.firebaseio.com/orders"),
    refFeatured = new Firebase("https://testingcart-28808.firebaseio.com/featured"),
    refMenu = new Firebase("https://testingcart-28808.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
